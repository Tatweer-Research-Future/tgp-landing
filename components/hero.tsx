...
export function Hero() {
  ...
  return (
    <section
      className="group relative z-0 overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-32 dark:bg-gradient-to-br dark:from-secondary/10 dark:via-background dark:to-accent/10"
      onMouseMove={(e) => {
      ...
      style={{
        backgroundImage: theme === "dark" ? "url('/Background.svg')" : "none",
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 z-0 block blur-2xl dark:hidden"
        aria-hidden
        style={{
          background:
            "radial-gradient(45vw 45vh at 8% 12%, oklch(0.62 0.21 300 / 0.22), transparent 60%)",
        }}
      />
      <div
        className="pointer-events-none absolute inset-0 z-0 block blur-2xl dark:hidden"
        ...
        style={{
          background:
            "radial-gradient(50vw 50vh at 92% 92%, oklch(0.7 0.15 190 / 0.25), transparent 60%)",
        }}
      />
